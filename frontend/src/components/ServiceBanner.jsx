...
const SERVICES = [
    ...
    },
    {
        ...
        subtitle: "Đổi trả dễ dàng, không rắc rối",
                ...
                {SERVICES.map((s) => (
                    ...
                    >
                        ...
                        <div className="min-w-0">
                            <p className="text-sm font-black text-gray-800 leading-snug text-vi">{s.title}</p>
                            <p className="text-[11px] text-gray-400 font-medium mt-0.5 leading-snug text-vi">{s.subtitle}</p>
                        </div>
                    </div>
                ))}
            </div>
